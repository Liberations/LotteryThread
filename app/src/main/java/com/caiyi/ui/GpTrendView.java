...
public class GpTrendView extends View implements OnDoubleTapListener, OnGestureListener, OnTouchListener {
    ...
    public GpTrendView(Context context, AttributeSet attributeSet, int i) {
    ...
    public GpTrendView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public GpTrendView(Context context) {
        this(context, null, 0);
    }
